...
namespace Server.Migrations
{
    ...
    [Migration("20181024101444_AddedManyToMany")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Server.Context.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Server.DbModels.Chat", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Server.DbModels.Department", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Server.DbModels.UserChat", b =>
                {
                    b.Property<int>("ChatId");
            ...
            modelBuilder.Entity("Server.DbModels.UserDepartment", b =>
                {
                    b.Property<string>("UserId");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Server.Context.ApplicationUser")
                        .WithMany()
            ...
            modelBuilder.Entity("Server.DbModels.Chat", b =>
                {
                    b.HasOne("Server.DbModels.Department")
                        .WithMany("Chats")
            ...
            modelBuilder.Entity("Server.DbModels.Message", b =>
                {
                    b.HasOne("Server.DbModels.Chat")
                        .WithMany("Messages")
                        .HasForeignKey("ChatId");

                    b.HasOne("Server.Context.ApplicationUser", "ApplicationUser")
                        .WithMany()
            ...
            modelBuilder.Entity("Server.DbModels.UserChat", b =>
                {
                    b.HasOne("Server.DbModels.Chat", "Chat")
                        .WithMany("UserChats")
                        .HasForeignKey("ChatId")
                        .OnDelete(DeleteBehavior.Cascade);
